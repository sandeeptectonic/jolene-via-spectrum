  ...
  customElements.define(
    ...
    class PairItWithSection extends HTMLElement {
      ...
      onVariantChange(e) {
        ...
        let comparePriceEl = priceRow.querySelector(
          ".pair-it-with__compare-price",
        );
        ...
        if (compareRaw > priceRaw) {
          var discountPct = Math.round(
            ((compareRaw - priceRaw) * 100) / compareRaw,
          );
      ...
      onAddToCart() {
        var checkedItems = this.querySelectorAll(
          ".pair-it-with__input:checked",
        );
